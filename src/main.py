...
from weapons import Weapon, C75_VIPER, L100_PYTHON_AP, L2_100_KINGSNAKE, L100_PYTHON_HEAT, L100_PYTHON_HESH, PERIHELION_L_VXC, SKYGUARD, JGX11
from vehicules import Vehicule, LIGHTNING
